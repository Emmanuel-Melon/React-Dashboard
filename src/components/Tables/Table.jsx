...
function EnhancedTableHead(props) {
    console.log(props)
    const { classes, customRows, onSelectAllClick, order, orderBy, numSelected, rowCount, onRequestSort } = props;
                                ...
                                .map((row, index) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCell align="left">{row.numberOfPickups}</TableCell>
